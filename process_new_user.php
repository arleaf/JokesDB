...
if ($new_password1 != $new_password2){
    echo "The passwords do not match. Pleasee try again.";
    exit;
}
...
if(sizeof($matches ) == 0){
    echo "The password must have at least one apecial character like !@#$%^&*()<br>";
    exit;
}

if (strlen($new_password1) <= 8){
    echo "The password must have be at least 8 characters long <br>";
    exit;
}
